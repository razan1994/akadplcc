...
class MedicineCompany extends Authenticatable
{
    ...
    public function images(){
        return $this->hasMany(MedicineImage::class,'medicine_id');
    }

    // Relation With Equipment Category Table
    // Created By : Mohammed Salah
    public function categories(){
        return $this->hasMany(MedicineCategory::class,'medicine_id');
    }

    // Relation With Equipment Product Table
    // Created By : Mohammed Salah
    public function products(){
        return $this->hasMany(MedicineProduct::class,'medicine_id');
    }
