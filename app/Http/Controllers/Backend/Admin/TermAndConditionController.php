...
class TermAndConditionController extends Controller
{
    ...
    // ======================= Store Function =========================
    // ================================================================
    public function store(StoreTermAndConditionFormRequest $request, Route $route)
    {
        try {
            $created_data = [
                'user_id' => 1,
    ...
    // ======================= Update Function ========================
    // ================================================================
    public function update($id, UpdateTermAndConditionFormRequest $request, Route $route)
    {
        try {
            $term_and_condition = TermAndCondition::find($id);
            if ($term_and_condition) {
