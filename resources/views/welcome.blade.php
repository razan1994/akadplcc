...
@section('page_title') Roshiita | Home @endsection
                                                    ...
                                                    <div class="item-card2">
                                                        ...
                                                        <div class="rating-stars d-inline-flex mb-1">
                                                            <input class="rating-value star" name="rating-stars-value"
                                                                readonly="readonly" type="number" value="5">
                                                            <div class="rating-stars-container mr-2">
                                                                <div class="rating-star  user_rate sm ">
                                                                    <i class="fa fa-star"></i>
                                                                </div>
                                                                <div class="rating-star  user_rate sm ">
                                                                    <i class="fa fa-star"></i>
                                                    ...
                                                    <div class="item-card2">
                                                        ...
                                                        <div class="rating-stars d-inline-flex mb-1">
                                                            <input class="rating-value star" name="rating-stars-value"
                                                                readonly="readonly" type="number" value="5">
                                                            <div class="rating-stars-container mr-2">
                                                                <div class="rating-star  user_rate sm " data-val="1" data-user_type="pharmacies" data-user_id="{{ encrypt($category->id) }}">
                                                                    <i class="fa fa-star"></i>
                                                                </div>
                                                                <div class="rating-star  user_rate sm " data-val="2" data-user_type="pharmacies" data-user_id="{{ encrypt($category->id) }}">
                                                                    <i class="fa fa-star"></i>
                                                                </div>
                                                                <div class="rating-star  user_rate sm " data-val="3" data-user_type="pharmacies" data-user_id="{{ encrypt($category->id) }}">
                                                                    <i class="fa fa-star"></i>
                                                                </div>
                                                                <div class="rating-star  user_rate sm " data-val="4" data-user_type="pharmacies" data-user_id="{{ encrypt($category->id) }}">
                                                                    <i class="fa fa-star"></i>
                                                                </div>
                                                                <div class="rating-star  user_rate sm" data-val="5" data-user_type="pharmacies" data-user_id="{{ encrypt($category->id) }}">
                                                                    <i class="fa fa-star"></i>
                                                                </div>
                                                            </div>5.0
                                                        </div>
                                                    ...
                                                    <div class="item-card2">
                                                        ...
                                                        <div class="rating-stars d-inline-flex mb-1">
                                                            <input class="rating-value star" name="rating-stars-value"
                                                                readonly="readonly" type="number" value="5">
                                                            <div class="rating-stars-container mr-2">
                                                                <div class="rating-star  user_rate sm " data-val="1" data-user_type="fitness-centers" data-user_id="{{ encrypt($category->id) }}">
                                                                    <i class="fa fa-star"></i>
                                                                </div>
                                                                <div class="rating-star  user_rate sm " data-val="2" data-user_type="fitness-centers" data-user_id="{{ encrypt($category->id) }}">
                                                                    <i class="fa fa-star"></i>
                                                                </div>
                                                                <div class="rating-star  user_rate sm " data-val="3" data-user_type="fitness-centers" data-user_id="{{ encrypt($category->id) }}">
                                                                    <i class="fa fa-star"></i>
                                                                </div>
                                                                <div class="rating-star  user_rate sm " data-val="4" data-user_type="fitness-centers" data-user_id="{{ encrypt($category->id) }}">
                                                                    <i class="fa fa-star"></i>
                                                                </div>
                                                                <div class="rating-star  user_rate sm" data-val="5" data-user_type="fitness-centers" data-user_id="{{ encrypt($category->id) }}">
                                                                    <i class="fa fa-star"></i>
                                                                </div>
                                                            </div>5.0
                                                        </div>
                                                    ...
                                                    <div class="item-card2">
                                                        ...
                                                        <div class="rating-stars d-inline-flex mb-1">
                                                            <input class="rating-value star" name="rating-stars-value"
                                                                readonly="readonly" type="number" value="5">
                                                            <div class="rating-stars-container mr-2">
                                                                <div class="rating-star  user_rate sm " data-val="1" data-user_type="life-coaches" data-user_id="{{ encrypt($category->id) }}">
                                                                    <i class="fa fa-star"></i>
                                                                </div>
                                                                <div class="rating-star  user_rate sm " data-val="2" data-user_type="life-coaches" data-user_id="{{ encrypt($category->id) }}">
                                                                    <i class="fa fa-star"></i>
                                                                </div>
                                                                <div class="rating-star  user_rate sm " data-val="3" data-user_type="life-coaches" data-user_id="{{ encrypt($category->id) }}">
                                                                    <i class="fa fa-star"></i>
                                                                </div>
                                                                <div class="rating-star  user_rate sm " data-val="4" data-user_type="life-coaches" data-user_id="{{ encrypt($category->id) }}">
                                                                    <i class="fa fa-star"></i>
                                                                </div>
                                                                <div class="rating-star  user_rate sm" data-val="5" data-user_type="life-coaches" data-user_id="{{ encrypt($category->id) }}">
                                                                    <i class="fa fa-star"></i>
                                                                </div>
                                                            </div>5.0
                                                        </div>
