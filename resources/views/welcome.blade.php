                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="category-item ch-400">
                            <img src="{{ asset('front_end_style/img/category-3.jpg') }}" />
                    ...
                    <div class="col-md-3">
                        <div class="category-item ch-250">
                            <img src="{{ asset('front_end_style/img/category-4.jpg') }}" />
                            <a class="category-name" href="">
                                <p>Some text goes here that describes the image</p>
                            </a>
                        </div>
                        <div class="category-item ch-150">
                            <img src="{{ asset('front_end_style/img/category-5.jpg') }}" />
                            <a class="category-name" href="">
                                <p>Some text goes here that describes the image</p>
                            </a>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="category-item ch-150">
                            <img src="{{ asset('front_end_style/img/category-6.jpg') }}" />
                            <a class="category-name" href="">
                                <p>Some text goes here that describes the image</p>
                            </a>
                        </div>
                        <div class="category-item ch-250">
                            <img src="{{ asset('front_end_style/img/category-7.jpg') }}" />
                            <a class="category-name" href="">
                                <p>Some text goes here that describes the image</p>
                            </a>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="category-item ch-400">
                            <img src="{{ asset('front_end_style/img/category-8.jpg') }}" />
                            <a class="category-name" href="">
                                <p>Some text goes here that describes the image</p>
                            </a>
                        </div>
                ...
                <div class="row align-items-center product-slider product-slider-4">
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="{{ asset('front_end_style/img/product-1.jpg') }}" alt="Product Image">
                                </a>
                    ...
                    <div class="col-lg-3">
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="{{ asset('front_end_style/img/product-2.jpg') }}" alt="Product Image">
                                </a>
                                <div class="product-action">
                                    <a href="#"><i class="fa fa-cart-plus"></i></a>
                                    <a href="#"><i class="fa fa-heart"></i></a>
                    ...
                    <div class="col-lg-3">
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="{{ asset('front_end_style/img/product-3.jpg') }}" alt="Product Image">
                                </a>
                                <div class="product-action">
                                    <a href="#"><i class="fa fa-cart-plus"></i></a>
                                    <a href="#"><i class="fa fa-heart"></i></a>
                    ...
                    <div class="col-lg-3">
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="{{ asset('front_end_style/img/product-4.jpg') }}" alt="Product Image">
                                </a>
                                <div class="product-action">
                                    <a href="#"><i class="fa fa-cart-plus"></i></a>
                                    <a href="#"><i class="fa fa-heart"></i></a>
                    ...
                    <div class="col-lg-3">
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="{{ asset('front_end_style/img/product-5.jpg') }}" alt="Product Image">
                                </a>
                                <div class="product-action">
                                    <a href="#"><i class="fa fa-cart-plus"></i></a>
                                    <a href="#"><i class="fa fa-heart"></i></a>
                ...
                <div class="row align-items-center product-slider product-slider-4">
                    <div class="col-lg-3">
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="{{ asset('front_end_style/img/product-6.jpg') }}" alt="Product Image">
                                </a>
                                <div class="product-action">
                                    <a href="#"><i class="fa fa-cart-plus"></i></a>
                                    <a href="#"><i class="fa fa-heart"></i></a>
                    ...
                    <div class="col-lg-3">
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="{{ asset('front_end_style/img/product-7.jpg') }}" alt="Product Image">
                                </a>
                                <div class="product-action">
                                    <a href="#"><i class="fa fa-cart-plus"></i></a>
                                    <a href="#"><i class="fa fa-heart"></i></a>
                    ...
                    <div class="col-lg-3">
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="{{ asset('front_end_style/img/product-8.jpg') }}" alt="Product Image">
                                </a>
                                <div class="product-action">
                                    <a href="#"><i class="fa fa-cart-plus"></i></a>
                                    <a href="#"><i class="fa fa-heart"></i></a>
                    ...
                    <div class="col-lg-3">
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="{{ asset('front_end_style/img/product-9.jpg') }}" alt="Product Image">
                                </a>
                                <div class="product-action">
                                    <a href="#"><i class="fa fa-cart-plus"></i></a>
                                    <a href="#"><i class="fa fa-heart"></i></a>
                    ...
                    <div class="col-lg-3">
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="{{ asset('front_end_style/img/product-10.jpg') }}" alt="Product Image">
                                </a>
                                <div class="product-action">
                                    <a href="#"><i class="fa fa-cart-plus"></i></a>
                                    <a href="#"><i class="fa fa-heart"></i></a>
            ...
            <div class="container-fluid">
                <div class="row align-items-center review-slider normal-slider">
                    <div class="col-md-6">
                        <div class="review-slider-item">
                            <div class="review-img">
                                <img src="{{ asset('front_end_style/img/review-1.jpg') }}" alt="Image">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="review-slider-item">
                            <div class="review-img">
                                <img src="{{ asset('front_end_style/img/review-2.jpg') }}" alt="Image">
                            </div>
                            <div class="review-text">
                                <h2>Customer Name</h2>
                                <h3>Profession</h3>
                    ...
                    <div class="col-md-6">
                        <div class="review-slider-item">
                            <div class="review-img">
                                <img src="{{ asset('front_end_style/img/review-3.jpg') }}" alt="Image">
                            </div>
                            <div class="review-text">
                                <h2>Customer Name</h2>
                                <h3>Profession</h3>
