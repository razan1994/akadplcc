                            ...
                            <tr>
                                <td style="padding:48px 0 30px 0; text-align: center; font-size: 14px; color: #4C83EE;">
                                    <a href="{{ route('welcome') }}"
                                        style="text-decoration: none; color: #4C83EE; font-size: 24px; line-height: 150%; font-weight: 400; letter-spacing: 0.01em; font-family: 'Open Sans', sans-serif !important">
                                        {{ config('app.name') }}
                                    </a>
                                </td>
                            </tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="padding: 0 0 16px;">
                                                    <span
                                                        style="display: block; width: 100%; border-bottom: 1px solid #8B949F;"></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
