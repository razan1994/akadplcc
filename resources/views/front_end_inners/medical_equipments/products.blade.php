							...
							<aside class="app-sidebar doc-sidebar my-dash">
								<div class="app-sidebar__user clearfix">
									<ul class="side-menu">
                                        ...
                                        <li data-toggle="tab" href="#createProduct" @if(old('name_en') != null || old('name_ar') != null) class="active" @endif style="cursor: pointer">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($products as $product)
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center"><a class="btn btn-success btn-sm" href="{{ route('medical_equipment.medical_equipment-edit-product',encrypt($product->id)) }}"><i class="fa fa-edit"></i></a></td>
                                                    </tr>
                                                @endforeach
                                                @else
                                                <tr>
                                                    <td colspan="4" style="text-align: center"><h4 class="tex-danger"> No Categories ...</h4></td>
                                                </tr>
                                                @endif
                                            </tbody>
                                        </table>
                        ...
                        <div id="createCategory" class="tab-pane fade @if(old('name_en') != null || old('name_ar') != null) active in @endif">
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="card mb-0">
                                    ...
                                    <div class="col-md-12 p-1 mt-2">
                                        <form action="{{ route('medical_equipment.medical_equipment-store-product') }}" method="POST" class="form">
                                            @csrf
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea type="text" name="description_ar" class="form-control" placeholder="Medical Equipment Product Description In Arabic" value="{{ old('description_ar') }}">
                                                            </textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea type="text" name="description_en" class="form-control" placeholder="Medical Equipment Product Description In English" value="{{ old('description_en') }}">
                                                            </textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group mb-0">
                                                            ...
                                                            <div class="custom-file">
                                                                <input type="file" class="custom-file-input" name="profile_phimageoto_path">
