                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="card mb-0">
                                    ...
                                    <div class="col-md-12 p-1 mt-2">
                                        <form action="{{ route('medical_equipment.medical_equipment-update-category',encrypt($category->id)) }}" method="POST" class="form">
                                            @csrf
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-sm-6 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="name_en" class="form-control" placeholder="Medical Equipment Name In English" value="{{ $category->name_en }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6 col-md-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Name AR <span class="text-danger">* @error('name_ar'){{ $message }}@enderror</span></label>
                                                            <input type="text" name="name_ar" class="form-control" placeholder="Medical Equipment Name In Arabic" value="{{ $category->name_ar }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="status" id="" class="form-control">
                                                                ...
                                                                <option value="2" @if($category->status == 'Inactive') selected @endif>Stop</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
