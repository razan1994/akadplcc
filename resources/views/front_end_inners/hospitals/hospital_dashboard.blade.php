			...
			<div class="container">
				<div class="row">
						...
						<div class="card">
							...
							<div class="card-body text-center item-user">
								<div class="profile-pic">
									...
									<a href="{{ route('hospital.hospital-dashboard') }}" class="text-dark"><h4 class="mt-3 mb-0 font-weight-semibold">{{ $auth->name_en }}</h4></a>
								</div>
							</div>
							<aside class="app-sidebar doc-sidebar my-dash">
								<div class="app-sidebar__user clearfix">
									<ul class="side-menu">
										<li data-toggle="tab" href="#profiletab" @if(isset($active))@if($active == "hospitalUpdateProfile" || $active == null) class="active" @endif @else class="active" @endif style="cursor: pointer">
											<a class="side-menu__item"><i class="fa fa-angle-right mr-2"></i><span class="side-menu__label ml-2">Edit Profile</span></a>
										</li>
										<li data-toggle="tab" href="#weekPlantab" @if(isset($active))@if($active == "hospitalWeekPlan") class="active" @endif @endif style="cursor: pointer">
                    ...
                    <div class="tab-content col-xl-9 col-lg-12 col-md-12">
                        <div id="profiletab" class="tab-pane fade @if(isset($active))@if($active == "hospitalUpdateProfile" || $active == null) active in @endif @else active in @endif">
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="card mb-0">
                                    <div class="card-header">
                                        <h3 class="card-title">Edit Profile</h3>
                                    </div>
                                    <form action="{{ route('hospital.hospital-update-profile',$auth->id) }}" method="POST" enctype="multipart/form-data" id="createForm">
                                        @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="name_ar" class="form-control" placeholder="hospital Name In Arabic" value="{{ $auth->name_ar }}">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        <label class="form-label">Name EN <span class="text-danger">* @error('name_en'){{ $message }}@enderror</span></label>
                                                        <input type="text" name="name_en" class="form-control" placeholder="hospital Name In English" value="{{ $auth->name_en }}">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                        ...
                        <div id="weekPlantab" class="tab-pane fade @if(isset($active))@if($active == "hospitalWeekPlan") active in @endif @endif">
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="card mb-0">
                                    <div class="card-header">
                                        <h3 class="card-title">Week Plan</h3>
                                    </div>
                                    <form action="{{ route('hospital.update-hospital-week-plan',$auth->id) }}" method="POST" enctype="multipart/form-data" id="createForm">
                                        @csrf
                                        <div class="card-body">
                                            <div class="row">
                        ...
                        <div id="gallery" class="tab-pane fade @if(isset($active))@if($active == "gallery") active in @endif @endif">
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="card mb-0">
                                    ...
                                    <form action="{{ route('hospital.hospital-store-images') }}" method="POST" enctype="multipart/form-data" id="createForm">
                                        @csrf
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-sm-6 col-md-6">
