						...
						<div class="card">
							...
							<div class="card-body item-user">
								...
								<div>
									...
									<h4><span class="font-weight-semibold"><i class="fa fa-book mr-3 mb-2"></i></span><a href="#" class="text-body">Languages :</a></h4>
							...
							<div class="wideget-user-tab wideget-user-tab3">
								<div class="tab-menu-heading">
									<div class="tabs-menu1">
										<ul class="nav">
											<li class=""><a href="#tab-5" class="active" data-toggle="tab">Informations</a></li>
												...
												<div class="col-xl-12 col-md-12">
													<ul class="list-unstyled widget-spec mb-0">
                                                        @foreach ($user->certificates as $certificate)
                                                            <li class="">
                                                                <a href="#" class="text-dark"><i class="fa fa fa-graduation-cap mr-2"></i>{{ $certificate->name_en }} | {{ $certificate->institution_name_en }}</a>
                                                            </li>
                                                        @endforeach
													</ul>
												</div>
