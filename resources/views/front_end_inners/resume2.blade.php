...
@section('content')
    <div class="body_inner">
        <div class="c_page_resume_2">
            <a href="{{ route('student.download-cv-2') }}" class="btn btn-primary btn-md hidePrint">
                Download cv
            </a>
                            ...
                            <div class="c_postionss">
                                <h4 id="job_title_txt">
                                    {{ isset($auth->info->job_title) ? $auth->info->job_title : 'Undefined' }} <a
                                        data-toggle="modal" data-target="#job_title_modal" style="cursor: pointer;"><i
                                            class="fas fa-edit"></i></a></h4>
                                <p id="over_view_txt">
                                    {!! isset($auth->info->over_view) ? $auth->info->over_view : 'Undefined' !!}
                                    <a data-toggle="modal" data-target="#over_view_modal" style="cursor: pointer;"><i
                    ...
                    <div class="c_body_cv">
                        <div class="c_padding_re">
                            ...
                            <div class="c_item c_exper">
                                ...
                                <div class="c_edotadd">
                                    <ol>
                                        <li><a data-toggle="modal" data-target="#experience_modal"
                            ...
                            <div class="c_item c_contact">
                                ...
                                <div class="c_edotadd">
                                    <ol>
                                        <li><a data-toggle="modal" data-target="#contact_info_modal"
                                                style="cursor: pointer;"><i class="fas fa-edit"></i></a></li>
                                    </ol>
                                </div>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group col-md-12">
                                <h5>الوصف :</h5>
                                <textarea rows="3" class="form-control" name="over_view" id="over_view" type="text"
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" name="experience_company"
                                    id="experience_company" placeholder="اسم الشركة">
                            </div>
                            <div class="form-group col-md-12">
                                <h5>المسمى الوظيفي :</h5>
                                <input type="text" class="form-control" name="experience_job_title"
                                    id="experience_job_title" placeholder="المسمى الوظيفي">
                            </div>
                            <div class="form-group col-md-12">
                                <h5>الخبرة :</h5>
                                <textarea rows="3" class="form-control" name="experience" id="experience" type="text"
                                    placeholder="الخبرة"></textarea>
                            </div>
                            <div class="form-group col-md-12">
                                <h5>من تاريخ :</h5>
                                <input type="date" class="form-control" name="from_date_ex" id="from_date_ex"
                                    type="text" max="<?= date('Y-m-d') ?>" placeholder="من تاريخ">
                            </div>
                            <div class="form-group col-md-12 row">
                                <div class="col-md-6">
                                    <h5>الى تاريخ :</h5>
                                    <input type="date" class="form-control" name="to_date_ex" id="to_date_ex"
                                        type="text" max="<?= date('Y-m-d') ?>" placeholder="الى تاريخ">
                                </div>
                                <div class="col-md-6">
                                    <h5>الى الان :</h5>
                                    <input type="checkbox" class="form-control" name="untill_now" id="untill_now"
                                        value="1" placeholder="الى تاريخ">
                                </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" name="phone" id="phone"
                                    value="{{ isset($auth->info->phone) ? $auth->info->phone : null }}"
                                    placeholder="رقم الهاتف">
                            </div>
                            <div class="form-group col-md-12">
                                <h5>البريد الالكتروني :</h5>
                                <input type="email" class="form-control" name="email" id="email"
                                    value="{{ isset($auth->info->email) ? $auth->info->email : null }}"
                                    placeholder="البريد الالكتروني example@example.com">
                            </div>
                            <div class="form-group col-md-12">
                                <h5>رابط التواصل :</h5>
                                <input type="url" class="form-control" name="link" id="link"
                                    value="{{ isset($auth->info->link) ? $auth->info->link : null }}"
                                    placeholder="رابط التواصل https://example.com">
                            </div>
                            <div class="form-group col-md-12">
                                <h5>العنوان :</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="flex-row d-flex">
                                    <input class="p-0 form-control" name="range" id="range" type="range"
                                        min="0" max="100" value="0"
                                        onchange="range_value(this.value);">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                <h5>من تاريخ :</h5>
                                <input type="date" class="form-control" name="from_date_edu" id="from_date_edu"
                                    type="text" max="<?= date('Y-m-d') ?>" placeholder="من تاريخ">
                            </div>
                            <div class="form-group col-md-12">
                                <h5>الى تاريخ :</h5>
                                <input type="date" class="form-control" name="to_date_edu" id="to_date_edu"
                                    type="text" max="<?= date('Y-m-d') ?>" placeholder="الى تاريخ">
                            </div>
                            <div class="form-group col-md-12">
