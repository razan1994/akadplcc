...
.modern-menu-item.active .modern-icon, .modern-menu-item:hover .modern-icon {
    color: #2563eb;
}
.modern-nav-text {
...
.modern-menu-item.active .modern-nav-text, .modern-menu-item:hover .modern-nav-text {
        ...
        <div class="sidebar-scrollbar modern-scrollbar">
            <ul class="nav sidebar-inner modern-sidebar-list" id="sidebar-menu">
                ...
                <li class="has-sub active expand modern-menu-item">
                    <a class="sidenav-item-link modern-link" href="javascript:void(0)" data-toggle="collapse" data-target="#user"
                        ...
                        <div class="sub-menu">
                            <li class="active modern-submenu-item">
                                <a class="sidenav-item-link modern-link"
                                    ...
                                    <i class="mdi mdi-account-group modern-icon"></i><span class="pl-1 nav-text modern-nav-text"> Admin Users</span>
                                </a>
                            </li>
                        </div>
                    </ul>
                ...
                <li class="has-sub active expand">
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#job"
                        aria-expanded="false" aria-controls="job">
                        <i class="fas fa-briefcase"> </i>
                        <span class="pl-1 nav-text" style="font-size: 9pt;color:white !important;"> Website Layout </span> <b
                            class="caret"></b>
                    </a>
                        ...
                        <div class="sub-menu">
                            ...
                            <li class="active">
                                <a class="sidenav-item-link" href="{{ route('super_admin.researches.index') }}">
                                    <i class="fas fa-briefcase"> </i>
                                    <span class="pl-1 nav-text" style="font-size: 9pt;color:white !important;"> Researches </span>
                                </a>
                            </li>
                            {{-- <li class="active">
                            ...
                            <li class="active">
                                <a class="sidenav-item-link" href="{{ route('super_admin.about_us-index') }}">
                                    <i class="fas fa-briefcase"> </i>
                                    <span class="pl-1 nav-text" style="font-size: 9pt;color:white !important;"> About Us </span>
                                </a>
                            </li>
                            <li class="active">
                                <a class="sidenav-item-link" href="{{ route('super_admin.sliders-index') }}">
                                    <i class="fas fa-briefcase"> </i>
                                    <span class="pl-1 nav-text" style="font-size: 9pt;color:white !important;"> Slider</span>
                                </a>
                            </li>
                            <li class="active">
                                <a class="sidenav-item-link" href="{{ route('super_admin.banners.index') }}">
                                    <i class="fas fa-briefcase"> </i>
                                    <span class="pl-1 nav-text" style="font-size: 9pt;color:white !important;"> Banners</span>
                                </a>
                            </li>
                            <li class="active">
                                <a class="sidenav-item-link" href="{{ route('super_admin.approved_bodies-index') }}">
                                    <i class="fas fa-briefcase"> </i>
                                    <span class="pl-1 nav-text" style="font-size: 9pt;color:white !important;"> Approved Bodies</span>
                                </a>
                            </li>
                            <li class="active">
                                <a class="sidenav-item-link"
                                    ...
                                    <i class="fas fa-briefcase"> </i>
                                    <span class="pl-1 nav-text" style="font-size: 9pt;color:white !important;"> Term & Conditions</span>
                                </a>
                            </li>
                            <li class="active">
                                <a class="sidenav-item-link"
                                    ...
                                    <i class="fas fa-briefcase"> </i>
                                    <span class="pl-1 nav-text" style="font-size: 9pt;color:white !important;"> Privacy Policy</span>
                                </a>
                            </li>
                        </div>
                    </ul>
