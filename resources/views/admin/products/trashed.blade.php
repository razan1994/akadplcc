    ...
    <div class="content-wrapper">
        <div class="content">
            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                <div>
                    <h1><i class="fas fa-user-md"></i> All Products Archived</h1>
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('super_admin.products-index') }}">
                                    <i class="fas fa-spell-check"></i> All Products
                                </a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page"><i
                                class="mdi mdi-delete"></i> All Products Archived
                            </li>
                        </ol>
                    </nav>
                </div>
                                    ...
                                    @foreach ($products as $index => $product)
                                        <tr>
                                            ...
                                            <td style="text-align: center">
                                                <a href="{{ route('super_admin.products-softDeleteRestore', $product->id) }}" class="unarchive mb-1 btn btn-sm btn-success"><i class="mdi mdi-redo-variant"></i></a>
