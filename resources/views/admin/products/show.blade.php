        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb p-0">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><i class="mdi  mdi-account-multiple"></i> Product Details</li>
                </ol>
            </nav>
        </div>
        <div>
            <a href="{{ route('super_admin.products-create') }}" class="mb-1 btn btn-primary"><i class="mdi mdi-playlist-plus"></i> Add New </a>
            <a href="{{ route('super_admin.products-edit', $product->id) }}" class="mb-1 btn btn-success"><i class="mdi mdi-playlist-edit"></i> Edit This Product </a>
        </div>
    </div>
            ...
            <div class="col-lg-8 col-xl-9">
                <div class="profile-content-right py-5">
                    ...
                    <ul class="nav nav-tabs px-3 px-xl-5 nav-style-border" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" id="timeline-tab" data-toggle="tab" href="#tab_1" role="tab" aria-controls="timeline" aria-selected="true"> Product Info</a>
                        </li>

                        {{-- Product Images Tab Title --}}
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#tab_2" role="tab" aria-controls="profile" aria-selected="false"> Product Images</a>
                        </li>

                        {{-- Product Orders Tab Title --}}
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#tab_3" role="tab" aria-controls="profile" aria-selected="false"> Product Orders</a>
                        </li>

                        {{-- Product Reviews Tab Title --}}
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#tab_4" role="tab" aria-controls="profile" aria-selected="false"> Product Reviews</a>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane fade show active" id="tab_1" role="tabpanel" aria-labelledby="timeline-tab">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-xl-6 col-sm-6">
                                        <div class="card card-mini mb-4">
                                            <div class="card-body">
                                                    <h2 class="mb-1">{{ isset($penddingOrders) ? $penddingOrders->count() : 0 }} orders</h2>
                                                <h5 style="color: orange;"><i class="mdi mdi-star mdi-spin"></i> Pendding Orders In Admin
                                                </h5>
                                    ...
                                    <div class="col-xl-6 col-sm-6">
                                        <div class="card card-mini  mb-4">
                                            <div class="card-body">
                                                <h2 class="mb-1">{{ isset($acceptedOrders) ? $acceptedOrders->count() : 0 }} orders</h2>
                                                <h5 style="color: green;"><i class="mdi mdi-star mdi-spin"></i> Accept Orders In Admin
                                                </h5>
                                                <div class="chartjs-wrapper">
                                    ...
                                    <div class="media widget-media p-4 bg-white border">
                                        ...
                                        <div class="media-body align-self-center">
                                            <h4 class="text-primary mb-2">
                                                {{ isset($product->cartOperations) ? $product->cartOperations->count() : 0 }}</h4>
                            ...
                            <div class="media mt-3 profile-timeline-media">
                                <div class="media-body">
                                    <h3 class="py-3 text-dark"><i class="mdi mdi-information"></i> Main Product Information :</h3>
                                    <table class="table table-hover table-striped">
                                        <thead>
                                            <tr>
                                                <th><i class="mdi mdi-account"></i> Name EN : <span style="color:blue;">{!! isset($product->name_en) ? $product->name_en : '<span style="color:red;">Undefined</span>' !!}</span></th>
                                                <th><i class="mdi mdi-account"></i> Name AR : <span style="color:blue;">{!! isset($product->name_ar) ? $product->name_ar : '<span style="color:red;">Undefined</span>' !!}</span></th>
                                            </tr>
                                            <tr>
                                                <th><i class="mdi mdi-account"></i> Category AR : <span style="color:blue;">{!! isset($product->category->name_ar) ? $product->category->name_ar : '<span style="color:red;">Undefined</span>' !!}</span></th>
                                                <th><i class="mdi mdi-account"></i> Category EN : <span style="color:blue;">{!! isset($product->category->name_en) ? $product->category->name_en : '<span style="color:red;">Undefined</span>' !!}</span></th>
                                            </tr>
                                            <tr>
                                                <th><i class="mdi mdi-phone"></i> Sale Price : <span style="color:blue;">{!! isset($product->sale_price) ? $product->sale_price . '<small> SAR</small>': '<span style="color:red;">Undefined</span>' !!}</span></th>
                                                <th><i class="mdi mdi-email"></i> On Sale Price Status : <span style="color:blue;">{!! isset($product->on_sale_price_status) ? $product->on_sale_price_status : '<span style="color:red;">Undefined</span>' !!}</span></th>
                                            </tr>
                                            <tr>
                                                <th><i class="mdi mdi-phone"></i>  Available Quantity : <span style="color:blue;">{!! isset($product->quantity_available) ? $product->quantity_available : '<span style="color:red;">Undefined</span>' !!}</span></th>
                                                <th><i class="mdi mdi-email"></i> Limit Quantity : <span style="color:blue;">{!! isset($product->quantity_limit) ? $product->quantity_limit : '<span style="color:red;">Undefined</span>' !!}</span></th>
                                            </tr>
                                            <tr> 
                                                <th><i class="mdi mdi-phone"></i>  On Sale Price : <span style="color:blue;">{!! isset($product->on_sale_price) ? $product->on_sale_price . '<small> SAR</small>': '<span style="color:red;">Undefined</span>' !!}</span></th>
                                                <th><i class="mdi mdi-phone"></i>  Status : <span style="color:blue;">{!! isset($product->status) ? $product->status : '<span style="color:red;">Undefined</span>' !!}</span></th>
                                            </tr>
                                            <tr>
                                                <th><i class="mdi mdi-account-multiple"></i> Weight : <span style="color:blue;">{!! isset($product->weight) ? $product->weight . '<small> '. $product->weight_unit .'</small>' : '<span style="color:red;">Undefined</span>' !!}</span></th>
                                                <th><i class="mdi mdi-phone"></i>  Number of Orders : <span style="color:blue;">{!! isset($product->cartOperations) ? $product->cartOperations->count() . ' orders' : '<span style="color:red;">Undefined</span>' !!}</span></th>
                                            </tr>
                                            <tr>
                                                <th><i class="mdi mdi-clock-outline mdi-spin"></i> Added Since : <span style="color:blue;">{!! isset($product->created_at) ? $product->created_at->diffForHumans() : '<span style="color:red;">Undefined</span>' !!}</span></th>
                                                <th><i class="mdi mdi-clock-outline mdi-spin"></i> Date & Time of Addtion : <span style="color:blue;">{!! isset($product->created_at) ? date('Y.d.m / h:i A', strtotime($product->created_at)) : '<span style="color:red;">Undefined</span>' !!}</span>
                                                </th>
                                            </tr>
                                        </thead>
                                    </table>
                                    ...
                                    {{-- ============== Product Description ============== --}}
                                    {{-- ================================================= --}}
                                    <h3 class="py-3 text-dark"><i class="mdi mdi-information"></i> Product Main Description AR/EN :</h3>
                                    <table class="table table-hover table-striped">
                                        <thead>
                                            <tr>
                                    ...
                                    <h3 class="py-3 text-dark"><i class="mdi mdi-information"></i> Product Sub Description AR/EN :</h3>
                                    <table class="table table-hover table-striped">
                                        <thead>
                                            <tr>
                                    ...
                                    <h3 class="py-3 text-dark"><i class="mdi mdi-information"></i> Product Ingredients AR/EN :</h3>
                                    <table class="table table-hover table-striped">
                                        <thead>
                                            <tr>
                                                <th><span style="color:blue;">{!! isset($product->ingredient_en) ? $product->ingredient_en : '<span style="color:red;">Undefined</span>' !!}</th>
                                            </tr>
                                            <tr>
                                                <th><span style="color:blue;">{!! isset($product->ingredient_ar) ? $product->ingredient_ar : '<span style="color:red;">Undefined</span>' !!}</th>
                                            </tr>
                                        </thead>
                                    </table>
                                    <h3 class="py-3 text-dark"><i class="mdi mdi-information"></i> Product Benefits AR/EN :</h3>
                                    <table class="table table-hover table-striped">
                                        <thead>
                                            <tr>
                                                <th><span style="color:blue;">{!! isset($product->benefit_en) ? $product->benefit_en : '<span style="color:red;">Undefined</span>' !!}</th>
                                            </tr>
                                            <tr>
                                                <th><span style="color:blue;">{!! isset($product->benefit_ar) ? $product->benefit_ar : '<span style="color:red;">Undefined</span>' !!}</th>
                                            </tr>
                                        </thead>
                                    </table>
                                </div>
                                        ...
                                        <div class="card card-default"  style="background-color:rgb(236, 233, 233);">
                                            <div class="card-body">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form action="{{ route('super_admin.products-addImages', $product->id) }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                    ...
                                                    <div class="col-md-3 c_right">
                                                        ...
                                                        <div class="c_review">
                                                            <div class="c_newstarr">
                                                                ...
                                                                @elseif(singleProductReviewStarsNumber(singleRealProductReview($product->id)) == 0.5)
                                                                    <label for="rating-5"><i class="fas fa-star-half-alt"></i></label>
                                                                @else
                                                                ...
                                                                @elseif(singleProductReviewStarsNumber(singleRealProductReview($product->id)) == 1.5)
                                                                    <label for="rating-4"><i class="fas fa-star-half-alt"></i></label>
                                                                @else
                                                                ...
                                                                @elseif(singleProductReviewStarsNumber(singleRealProductReview($product->id)) == 2.5)
                                                                    <label for="rating-3"><i class="fas fa-star-half-alt"></i></label>
                                                                @else
                                                                ...
                                                                @elseif(singleProductReviewStarsNumber(singleRealProductReview($product->id)) == 3.5)
                                                                    <label for="rating-2"><i class="fas fa-star-half-alt"></i></label>
                                                                @else
                                                                ...
                                                                @elseif(singleProductReviewStarsNumber(singleRealProductReview($product->id)) == 4.5)
                                                                    <label for="rating-1"><i class="fas fa-star-half-alt"></i></label>
                                                                @else
                                                        ...
                                                        <div class="c_num_reveiws">
                                                            <span>Reviews: {{ (isset($product->productReviews)) ? $product->productReviews->count() : 0 }}</span>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                ...
                                                                <div class="c_progress">
                                                                    <div class="c_bar" style="width:{{ number_format(productReviewPercentageDetails($product->id, 5), 2) }}%">
                                                                        <p class="c_percent"></p>
                                                                    </div>
                                                                </div>
                                                                <div class="c_nespam">{{ number_format(productReviewPercentageDetails($product->id, 5), 2) }}%</div>
                                                            </li>
                                                            <li>
                                                                <span>4</span>
                                                                <div class="c_progress">
                                                                    <div class="c_bar" style="width:{{ number_format(productReviewPercentageDetails($product->id, 4), 2) }}%">
                                                                        <p class="c_percent"></p>
                                                                    </div>
                                                                </div>
                                                                <div class="c_nespam">{{ number_format(productReviewPercentageDetails($product->id, 4), 2) }}%</div>
                                                            </li>
                                                            <li>
                                                                <span>3</span>
                                                                <div class="c_progress">
                                                                ...
                                                                <div class="c_nespam">{{ number_format(productReviewPercentageDetails($product->id, 3), 2) }}%</div>
                                                            </li>
                                                            <li>
                                                                <span>2</span>
                                                                <div class="c_progress">
                                                                    <div class="c_bar" style="width:{{ number_format(productReviewPercentageDetails($product->id, 2), 2) }}%">
                                                                        <p class="c_percent"></p>
                                                                    </div>
                                                                </div>
                                                                <div class="c_nespam">{{ number_format(productReviewPercentageDetails($product->id, 2), 2) }}%</div>
                                                            </li>
                                                            <li>
                                                                <span>1</span>
                                                                <div class="c_progress">
                                                                    <div class="c_bar" style="width:{{ number_format(productReviewPercentageDetails($product->id, 1), 2) }}%">
                                                                        <p class="c_percent"></p>
                                                                    </div>
                                                                </div>
                                                                <div class="c_nespam">{{ number_format(productReviewPercentageDetails($product->id, 1), 2) }}%</div>
                                                            </li>
                                                    ...
                                                    <div class="col-md-4">
                                                        @if (isset($productReview->customer->profile_photo_path))
                                                            @if ($productReview->customer->profile_photo_path && file_exists($productReview->customer->profile_photo_path))
                                                                <img src="{{ asset($productReview->customer->profile_photo_path) }}" width="100" alt="Image">
                                                            @else
                                                                <img src="{{ asset('front_end_style/images/profilesf.png') }}" width="100" alt="Image">
                                                            @endif
                                                        @else
                                                            <img src="{{ asset('front_end_style/images/profilesf.png') }}" width="100" alt="Image">
                                                        @endif
