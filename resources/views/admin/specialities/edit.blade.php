    ...
    <div class="content-wrapper">
        <div class="content">
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                ...
                {{-- ============================================== --}}
                <div>
                    <h1><i class="mdi mdi-playlist-edit"></i> Update Speciality</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('super_admin.specialities-index') }}">
                                    <i class="mdi mdi-account-group"></i> All Specialities
                                </a>
                            </li>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card card-default">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('super_admin.specialities-update', [$speciality->id]) }}" method="POST"
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="name_ar"
                                                            ...
                                                            value="{{ isset($speciality->name_ar) ? $speciality->name_ar : null }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="name_en"
                                                            ...
                                                            value="{{ isset($speciality->name_en) ? $speciality->name_en : null }}">
                                                    </div>
                                                </div>
                                            </div>
