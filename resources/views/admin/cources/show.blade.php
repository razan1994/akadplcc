...
@section('content')
    ...
    <div class="breadcrumb-wrapper breadcrumb-contacts">
        ...
        <div>
            <a href="{{ route('super_admin.latest_news-edit', $news_blog->id) }}" class="mb-1 btn btn-primary"><i
    ...
    <div class="bg-white border rounded">
        ...
        <div class="row no-gutters">
            ...
            <div class="col-md-6">
                <div class="profile-content-left pt-5 pb-3 px-3 px-xl-5">
                    <div class="text-center pb-4">
                        <h4 class="text-dark mb-3"> News Details EN :</h4>
                        <p style="color: blue">
            ...
            <div class="col-md-6">
                <div class="profile-content-left pt-5 pb-3 px-3 px-xl-5">
                    <div class="text-center pb-4">
                        <h4 class="text-dark mb-3"> News Details AR :</h4>
