    ...
    <div class="content-wrapper">
        <div class="content">
            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                <div>
                    <h1><i class="mdi mdi-account-multiple"></i> All Sub Categories</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb p-0">
                            <li class="breadcrumb-item">
                                <a href="{{ route('super_admin.dashboard') }}"> <i class="mdi  mdi-home"></i> Dashboard </a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page"><i class="mdi  mdi-account-multiple"></i> All Sub Categories</li>
                        </ol>
                    </nav>
                </div>
                <div>
                    <a href="{{ route('super_admin.subCategories-create') }}" class="mb-1 btn btn-primary"><i class="mdi mdi-playlist-plus"></i> Add New </a>
                    <a href="{{ route('super_admin.subCategories-showSoftDelete') }}" class=" mb-1 btn btn-danger"><i class=" mdi mdi-delete"></i> Archive </a>
                </div>
            </div>
                                    ...
                                    @foreach ($subCategories as $index => $category)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('super_admin.subCategories-edit', [$category->id]) }}" title="Edit" class="mb-1 btn btn-sm btn-primary"><i class="mdi mdi-playlist-edit"></i></a>
                                                <a href="{{ route('super_admin.subCategories-activeInactiveSingle', [$category->id]) }}" title="Active / Inactive" class="process mb-1 btn btn-sm {{ $category->status == 1 ? 'btn-warning' : 'btn-success' }}"><i class="mdi mdi-stop"></i></a>
                                                <a href="{{ route('super_admin.subCategories-softDelete', [$category->id]) }}" title="Archive" class="confirm mb-1 btn btn-sm btn-danger"><i class="mdi mdi-close"></i></a>
