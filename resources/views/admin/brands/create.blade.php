    ...
    <div class="content-wrapper">
        <div class="content">
            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                ...
                {{-- ============================================== --}}
                <div>
                    <h1><i class="mdi mdi-playlist-plus"></i> Add New Brand</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('super_admin.brands-index') }}"> <i class="mdi mdi-account-group"></i> All Brands </a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page"><i class="mdi mdi-playlist-plus"></i> Add New Brand</li>
                        </ol>
                    </nav>
                </div>
