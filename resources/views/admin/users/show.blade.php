                    ...
                    <ul class="nav nav-tabs px-3 px-xl-5 nav-style-border" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#tab_3" role="tab"
                                aria-controls="profile" aria-selected="false"><i class="mdi mdi-currency-usd"></i> Posts</a>
                        </li>
                                    ...
                                    <div class="col-xl-6 col-sm-6">
                                        <div class="card card-mini mb-4">
                                            <div class="card-body">
                                                ...
                                                @endif
                                                <h5 style="color: orange;"><i class="mdi mdi-star mdi-spin"></i> Active Ads
                                                </h5>
                                    ...
                                    <div class="col-xl-6 col-sm-6">
                                        <div class="card card-mini  mb-4">
                                            <div class="card-body">
                                                ...
                                                @endif
                                                <h5 style="color: green;"><i class="mdi mdi-star mdi-spin"></i> Pendding Ads
                                                </h5>
                                                <div class="chartjs-wrapper">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card card-default" data-scroll-height="550">
                                            <div class="card-header justify-content-between "
                                                style="background-color: #4c84ff;">
                                                <h2 style="color:white;"><i class="mdi mdi-check text-white "></i> Pendding
                                                    Ads :</h2>
                                            </div>
                                            <div class="card-body slim-scroll" style="background-color: #eff4ff;">
