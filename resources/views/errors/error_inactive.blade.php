		...
		<div class="page page-h">
			<div class="page-content z-index-10">
				<div class="container text-center">
					<div class="display-1 text-white mb-5">401</div>
					<h1 class="h2 text-white  mb-3">User Not Activated</h1>
					<p class="h4 font-weight-Automatic mb-7 leading-Automatic text-white">Oops!!!! your user may be blocked from the system !!!</p>
